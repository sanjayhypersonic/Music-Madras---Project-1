...
export const VIDEOS_DATA: Video[] = [
  ...
  },
  {
    ...
    artist: "The Chennai Chorale",
    category: 'Vocal',
    duration: '03:31',
    views: '713',
    publishedAt: '5 months ago',
    description: "A beautiful, authentic live choral performance of the traditional Tamil Christmas song 'Ambara Umbara'. High-fidelity live audio capturing the natural room acoustics.",
    likesCount: 98,
